...
def explore(request):
    edu_books = BooksModel.objects.filter(category='Education')
    fiction_books = BooksModel.objects.filter(category='Fiction')
    science_books = BooksModel.objects.filter(category='Science')
